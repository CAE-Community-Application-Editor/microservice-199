...
public class music extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "199", version = "$Metadata_Version$",
          description = "$Metadata_Description$",
          termsOfService = "$Metadata_Terms$",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/CAE-Community-Application-Editor/microservice-199/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  @ApiResponses(value = {
       @ApiResponse(code = HttpURLConnection.HTTP_OK, message = "music")
  })
  @ApiOperation(value = "music", notes = " ")
  public Response music() {
